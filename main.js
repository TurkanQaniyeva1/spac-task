...
//  edin function daxilinde try catch istifade ederek yazin 
...
//         return userMap; 
//     } catch (error) {
//         console.error( error.message, "Xəta",);
//         return null; 
//     }
// }

// const userMap = person(users);
// console.log(userMap); 
...
//         if (!user) {
//             console.log(` ${id} olan istifadəçi tapılmadı.`);
//         } else {
//             console.log(` ${id} olan istifadəçinin rolu: ${user.role}`);
//         }
...
// function deleteid(userMap, id) {
//     try {
 
//         const user = userMap.get(id);

//         if (!user) {
//             throw new Error(`${id} olan istifadəçi artıq mövcud deyil.`);
//         }

//         userMap.delete(id);
//         console.log(`${id} olan istifadəçi silindi.`);

//         if (!userMap.has(id)) {
//             console.log(`${id} olan istifadəçi artıq  mövcud deyil.`);
//         }
...
// const userMapp = new Map();
// users.forEach(user => userMapp.set(user.id, user));


// const userObject = Object.fromEntries(userMapp);

// const userArray = Object.values(userObject);

// console.log("Object formatında:", userObject);
// console.log("Array formatında:", userArray);
